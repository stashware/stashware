...
const WAIT_RPC_SHORT = int64(10)
const WAIT_RPC_MIDDLE = int64(30)
const WAIT_RPC_LONG = int64(60)
...
type CmdGetAddrTxsReq struct {
	...
	Height2 *int64 `json:"height2" validate:"omitempty,gte=0"`
}
...
type CmdPriceReq = struct {
	...
	Target string `json:"target" validate:"gte=0"`
}
...
type CmdGetBlockReq = struct {
	Current     int64  `json:"current"` //if==1, return tip of chain
